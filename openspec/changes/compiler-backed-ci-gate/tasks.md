...
- [x] 1.4 Confirm the lane fails when it should: on a scratch branch, break one fixture's committed `lib.rs` and confirm the new job goes red; revert. Verify: the failing run URL is recorded in the PR description. (Verified: deliberate-break run [34687060089](https://github.com/MediaNoxLabs/compact/actions/runs/34687060089) failed with `tiny` drift; clean baseline [34687039166](https://github.com/MediaNoxLabs/compact/actions/runs/34687039166) passed. Recorded in [PR #75](https://github.com/MediaNoxLabs/compact/pull/75).)
