    ...
    W: Witnesses<PS>,
{
    ...
    pub fn initial_state(
        ...
        let sv = new_array(vec![new_cell(false), new_cell(false), new_map(), new_map()]);
...
impl<'a, D: DB> Ledger<'a, D> {
    pub fn flag_set(&self) -> Result<bool, CompactError> {
    ...
    pub fn flag_map(&self) -> Result<bool, CompactError> {
        let qctx = QueryContext::new(
            self.state.clone(),
            midnight_compact_runtime::ContractAddress::default(),
        );
