...
impl FromFieldRepr for coin_info {
    ...
    fn from_field_repr(_repr: &[Fr]) -> Option<Self> {
        if _repr.len() < Self::FIELD_SIZE { return None; }
        let mut _offset = 0usize;
        let nonce = <Nonce as FromFieldRepr>::from_field_repr(&_repr[_offset.._offset + <Nonce as FromFieldRepr>::FIELD_SIZE])?;
        _offset += <Nonce as FromFieldRepr>::FIELD_SIZE;
        let opening = <opening as FromFieldRepr>::from_field_repr(&_repr[_offset.._offset + <opening as FromFieldRepr>::FIELD_SIZE])?;
...
impl FromFieldRepr for LeafPreimage {
    ...
    fn from_field_repr(_repr: &[Fr]) -> Option<Self> {
        ...
        let data = <commitment as FromFieldRepr>::from_field_repr(&_repr[_offset.._offset + <commitment as FromFieldRepr>::FIELD_SIZE])?;
...
impl FromFieldRepr for public_key {
    ...
    fn from_field_repr(_repr: &[Fr]) -> Option<Self> {
        if _repr.len() < Self::FIELD_SIZE { return None; }
        let mut _offset = 0usize;
        let zk = <zk_public_key as FromFieldRepr>::from_field_repr(&_repr[_offset.._offset + <zk_public_key as FromFieldRepr>::FIELD_SIZE])?;
