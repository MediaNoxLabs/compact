...
impl From<STATE> for midnight_compact_runtime::Value {
    fn from(v: STATE) -> midnight_compact_runtime::Value {
        midnight_compact_runtime::Value::from(v as u8)
    }
}
impl midnight_compact_runtime::BinaryHashRepr for STATE {
    ...
    W: Witnesses<PS>,
{
    ...
    pub(crate) fn in_state(
        ...
        let result = ({
            ...
            midnight_compact_runtime::std_lib::decode_via_field_repr::<STATE>(_av)?
        } == s);
        Ok(CircuitResults {
            result,
            context: ctx,
    ...
    pub fn get(
        ...
        {
            midnight_compact_runtime::std_lib::some::<Fr>({
                let _gather_ops = OpProgramGather::<DefaultDB>::new()
                    .dup(0)
            ...
            midnight_compact_runtime::std_lib::none::<Fr>()
        };
        Ok(CircuitResults {
            result,
            context: ctx,
        ...
        Ok(midnight_compact_runtime::std_lib::persistent_hash_aligned(
            &[
                midnight_compact_runtime::AlignedValue::from([
                    108u8, 97, 114, 101, 115, 58, 116, 105, 110, 121, 58, 112, 107, 58, 0, 0, 0, 0,
