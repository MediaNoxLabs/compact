...
impl FromFieldRepr for DigitalPassportCivilDate {
    ...
    fn from_field_repr(_repr: &[Fr]) -> Option<Self> {
        ...
        let mut _offset = 0usize;
        let year = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let month = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let day = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let yearAdjustedQuotient4 = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let yearAdjustedQuotient100 = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let yearAdjustedQuotient400 = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let marchBasedMonthDayOffset = <u32 as FromFieldRepr>::from_field_repr(
            &_repr[_offset.._offset + <u32 as FromFieldRepr>::FIELD_SIZE],
        )?;
        _offset += <u32 as FromFieldRepr>::FIELD_SIZE;
        let _ = _offset;
...
impl From<DigitalPassportCivilDate> for midnight_compact_runtime::Value {
    fn from(s: DigitalPassportCivilDate) -> midnight_compact_runtime::Value {
        ...
        _v.push(midnight_compact_runtime::Value::from(
            s.yearAdjustedQuotient4,
        ));
        _v.push(midnight_compact_runtime::Value::from(
            s.yearAdjustedQuotient100,
        ));
        _v.push(midnight_compact_runtime::Value::from(
            s.yearAdjustedQuotient400,
        ));
        _v.push(midnight_compact_runtime::Value::from(
            s.marchBasedMonthDayOffset,
        ));
        midnight_compact_runtime::Value::concat(_v.iter())
    }
}
...
pub mod pure_circuits {
    ...
    pub fn assert_valid_schema_capabilities(
        capabilities: SchemaCapabilities,
    ) -> Result<(), CompactError> {
        Ok(())
    }

    pub fn assert_valid_schema_family_resolution_hint(
    ...
    pub fn assert_valid_schema_descriptor(
    ...
    pub fn issuance_proof_payload_root(
        body_root: [u8; 32],
        proof: Proof,
    ) -> Result<[u8; 32], CompactError> {
    ...
    pub fn presentation_proof_payload_root(
        body_root: [u8; 32],
        proof: Proof,
    ) -> Result<[u8; 32], CompactError> {
        Ok(pure_circuits::proof_payload_root_for_context(
    ...
    pub fn presentation_proof_challenge(
        body_root: [u8; 32],
        proof: Proof,
    ) -> Result<Fr, CompactError> {
        Ok(pure_circuits::proof_challenge_for_context(
    ...
    pub fn assert_valid_issuance_context_proof(
        body_root: [u8; 32],
        proof: Proof,
    ) -> Result<(), CompactError> {
    ...
    pub fn assert_valid_presentation_context_proof(
        body_root: [u8; 32],
        proof: Proof,
    ) -> Result<(), CompactError> {
        Ok(pure_circuits::assert_valid_proof_for_context(
    ...
    pub(crate) fn assert_valid_credential_proof(
        credential: Credential,
        proof: Proof,
    ) -> Result<(), CompactError> {
    ...
    pub(crate) fn presentation_body_root(
    ...
    pub(crate) fn assert_valid_presentation_envelope(
        presentation: Presentation,
    ) -> Result<(), CompactError> {
    ...
    pub fn assert_valid_explicit_holder_binding(
    ...
    pub fn assert_valid_jubjub_holder_binding(
    ...
    pub fn secret_holder_binding_challenge_response(
        ...
        Ok(midnight_compact_runtime::std_lib::persistent_hash_aligned(
            &[
                midnight_compact_runtime::AlignedValue::from([
                    109u8, 105, 100, 110, 105, 103, 104, 116, 58, 118, 99, 58, 104, 111, 108, 100,
                    101, 114, 45, 99, 104, 97, 108, 108, 0, 0, 0, 0, 0, 0, 0, 0,
                ]),
    ...
    pub fn verifier_scoped_pseudonym(
        ...
        Ok(midnight_compact_runtime::std_lib::persistent_hash_aligned(
            &[
                midnight_compact_runtime::AlignedValue::from([
                    109u8, 105, 100, 110, 105, 103, 104, 116, 58, 118, 99, 58, 104, 111, 108, 100,
                    101, 114, 45, 112, 115, 101, 117, 100, 111, 110, 121, 109, 0, 0, 0, 0,
                ]),
                midnight_compact_runtime::AlignedValue::from(holder_secret),
    ...
    pub fn blinded_secret_holder_commitment(
        ...
        Ok(midnight_compact_runtime::std_lib::persistent_hash_aligned(
            &[
                midnight_compact_runtime::AlignedValue::from([
                    109u8, 105, 100, 110, 105, 103, 104, 116, 58, 118, 99, 58, 98, 108, 105, 110,
                    100, 45, 104, 111, 108, 100, 101, 114, 0, 0, 0, 0, 0, 0, 0, 0,
                ]),
    ...
    pub fn assert_valid_secret_holder_credential_binding(
    ...
    pub fn assert_valid_secret_holder_presentation_binding(
        binding: SecretHolderBinding,
    ) -> Result<(), CompactError> {
        compact_assert!(
            (binding.requestChallengeResponse
    ...
    pub fn assert_matching_schema_refs(
        expected: SchemaRef,
        actual: SchemaRef,
    ) -> Result<(), CompactError> {
    ...
    pub fn assert_valid_protocol_message_envelope(
    ...
    pub(crate) fn assert_valid_request_message_0(
    ...
    pub(crate) fn assert_valid_result_message_1(
    ...
    pub(crate) fn assert_valid_request_message_2(
    ...
    pub(crate) fn assert_valid_submission_message(
    ...
    pub fn assert_valid_status_registry_ref(
        registry_ref: StatusRegistryRef,
    ) -> Result<(), CompactError> {
        compact_assert!(
    ...
    pub fn assert_valid_registry_bound_status_binding(
    ...
    pub fn registry_bound_status_binding_root(
        binding: RegistryBoundStatusBinding,
    ) -> Result<[u8; 32], CompactError> {
    ...
    pub fn digital_passport_claim_root(
        ...
        Ok(midnight_compact_runtime::std_lib::persistent_hash_aligned(
            &[
                midnight_compact_runtime::AlignedValue::from([
                    ...
                    116, 97, 108, 45, 112, 97, 115, 115, 112, 111, 114, 116, 58, 118, 49, 0,
                ]),
    ...
    pub fn date_of_birth_commitment(
    ...
    pub fn document_number_null_commitment() -> Result<[u8; 32], CompactError> {
        Ok(midnight_compact_runtime::std_lib::persistent_hash_aligned(
            &[
                midnight_compact_runtime::AlignedValue::from([
                    109u8, 105, 100, 110, 105, 103, 104, 116, 58, 118, 99, 58, 100, 105, 103, 105,
                    116, 97, 108, 45, 112, 97, 115, 115, 112, 111, 114, 116, 58, 110, 105, 108,
                ]),
                midnight_compact_runtime::AlignedValue::from([
                    100u8, 111, 99, 117, 109, 101, 110, 116, 45, 110, 117, 109, 98, 101, 114, 0, 0,
    ...
    pub fn digital_passport_credential_body_root(
        credential: Credential,
    ) -> Result<[u8; 32], CompactError> {
        Ok(pure_circuits::credential_body_root(credential.clone())?)
    }

    pub fn digital_passport_presentation_body_root(
        presentation: Presentation,
    ) -> Result<[u8; 32], CompactError> {
    ...
    pub fn assert_valid_digital_passport_schema_ref(schema: SchemaRef) -> Result<(), CompactError> {
        ...
        compact_assert!(
            (schema.minorVersion == 0),
            "Digital-passport minor version mismatch"
        );
        Ok(())
    }
    ...
    pub fn assert_valid_digital_passport_credential(
        credential: Credential,
        proof: Proof,
    ) -> Result<(), CompactError> {
    ...
    pub(crate) fn assert_civil_date_matches_epoch_days(
        ...
        compact_assert!(
            ((t_4 <= ((year_adjusted) as u64))
                && (((year_adjusted) as u64)
                    < ((((date.yearAdjustedQuotient100) as u64).wrapping_mul((100) as u64))
                        as u64)
        ...
        compact_assert!(
            ((t_5 <= ((year_adjusted) as u64))
                && (((year_adjusted) as u64)
                    < ((((date.yearAdjustedQuotient400) as u64).wrapping_mul((400) as u64))
                        as u64)
        ...
        let month_numerator =
            ((((153) as u64).wrapping_mul((shifted_month) as u64)) as u64).wrapping_add((2) as u64);
        let t_6 = ((date.marchBasedMonthDayOffset) as u64).wrapping_mul((5) as u64);
        compact_assert!(
            ((t_6 <= month_numerator)
                && (month_numerator
                    < ((((date.marchBasedMonthDayOffset) as u64).wrapping_mul((5) as u64))
                        as u64)
            ...
            || (date.month == 12))
        {
            ...
            if (date.month == 2) {
                ...
                compact_assert!(
                    (t_7 <= 30),
                    "Civil date day exceeds the 30-day month length"
                );
            }
        }
        let t_7 = {
            let t_8 = (((((({
                ...
                .wrapping_add((date.yearAdjustedQuotient400) as u64))
                as u64)
                .wrapping_add((date.marchBasedMonthDayOffset) as u64))
                as u64)
    ...
    pub fn assert_valid_digital_passport_age_predicate(
        ...
        pure_circuits::assert_civil_date_matches_epoch_days(
    ...
    pub fn assert_valid_digital_passport_verification_request_message(
        ...
        Ok(
            pure_circuits::assert_valid_digital_passport_presentation_request(
                pure_circuits::digital_passport_presentation_request_from_protocol(
                    request.clone(),
                )?,
            )?,
        )
